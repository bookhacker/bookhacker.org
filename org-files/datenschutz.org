...
dieser Website eingeschränkt sein. Server-Log-Files
...
** Datenschutzerklärung für die Nutzung von Google Analytics
   :PROPERTIES:
   :CUSTOM_ID: datenschutzerklärung-für-die-nutzung-von-google-analytics
   :END:
...
*** Widerspruch gegen Datenerfassung
    :PROPERTIES:
    :CUSTOM_ID: widerspruch-gegen-datenerfassung
    :END:
...
** Widerspruch Werbe-Mails
   :PROPERTIES:
   :CUSTOM_ID: widerspruch-werbe-mails
   :END:
